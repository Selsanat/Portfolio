...
namespace NorthLab.Effects
{
    ...
    public class RetroScreenEditor : Editor
    {
        ...
        private SerializedProperty syncTransform;
        private SerializedProperty templateDisplayObject;
        ...
        private void OnEnable()
        {
            ...
            syncTransform = serializedObject.FindProperty(nameof(syncTransform));
            templateDisplayObject = serializedObject.FindProperty(nameof(templateDisplayObject));
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(syncTransform);
            EditorGUILayout.PropertyField(templateDisplayObject);
